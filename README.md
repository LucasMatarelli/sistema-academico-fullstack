...
### Detalhes do Plano de Teste (JMeter)

O arquivo `.jmx` contém a configuração completa para o teste de carga: 100 usuários, 5 repetições, com autenticação `admin/123` no endpoint `/alunos`.
